...
function BusinessPreferences() {
    return (
        <>
            <Row>
                <Col></Col>
                <Col xs={10} style={{ alignItems: "center", justifyContent: "center", display: "flex" }}>Business Preferences
                </Col>
                <Col></Col>
            </Row>
            <Row>
                <Col></Col>
                <Col xs={10} style={{ alignItems: "center", justifyContent: "center", display: "flex" }}>Tell us about your shop.
                </Col>
                <Col></Col>
            </Row>
            <br />
