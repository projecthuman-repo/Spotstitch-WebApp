				...
				<Modal.Body className="mt-0 pt-0 mx-3 d-flex flex-column">
					<section>
						<Row>
							...
							<Col lg={8}>
								<p className="nopadding fs-16 fw-500 my-1">
									{user.username}
								</p>
								<p className="nopadding fs-15 fw-300 my-1">
									{user.userType}
								</p>
								<p className="nopadding fs-15 fw-400">
									{user.email}
								</p>
							</Col>
						</Row>
						...
						<Row>
							{links.map((link) => {
								return (
									<Link
										to={link.destination}
										className="btn text-start my-1"
										onClick={handleClose}
									>
										<Row>
											<Col sm={1} lg={1} className="mx-2">
					...
					<section className="mt-auto">
						<Row className="mb-1">
							<Col>
								<button className="btn nopadding mt-auto">
									<p className="fw-600 mb-0">Your Accounts</p>
								</button>
							</Col>
						</Row>
						{[
						...
						<Row>
							<Col>
								<button className="btn nopadding mt-3">
									<p className="fw-600 mb-0">More Options</p>
								</button>
							</Col>
						</Row>
						{["See terms of service", "See privacy policy"].map(
							(option) => {
								return (
									<Row>
										<Col>
