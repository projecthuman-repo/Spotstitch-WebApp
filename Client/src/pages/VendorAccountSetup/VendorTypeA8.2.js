        ...
        <div className="right">
          ...
          <label className="whatbringyouradiobox">
            <input
              ...
              checked={
                selectedOption === "I already have a business to sell products."
              }
              onChange={() =>
                handleOptionSelected(
                  "I already have a business to sell products."
                )
              }
            />
          ...
          <label className="whatbringyouradiobox">
            <input
              ...
              checked={
                selectedOption ===
                "I want to promote and expand my business through Spotstitch."
              }
              onChange={() =>
                handleOptionSelected(
                  "I want to promote and expand my business through Spotstitch."
          ...
          <div className="skipnextbox">
            <Link to="/businessmethod" className="linknextbutton-vendortype">
              <button className="nextbutton-vendortype">Next</button>
            </Link>
            <Link to="/businessmethod" className="linkskipbutton-vendortype">
