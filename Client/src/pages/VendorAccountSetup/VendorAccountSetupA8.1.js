    ...
    <>
      <div className="boss">
        ...
        <div className="right">
          ...
          <div className="welcometitle-vendorsetup">
            Welcome Angela! Let's get your shop setup.
          </div>
          {/* <div className="space1" /> */}
          {/* <br /> */}
          <div className="smalldescription-vendorsetup">
          ...
          <br />
          <br /> */}
          <Link to="/vendortype" className="linknextbutton-vendorsetup">
            <button className="nextbutton-vendorsetup">Next</button>
          </Link>
