        ...
        <>
            <div className="boss">
                ...
                <div className="right">
                    ...
                    <img src={image || photo} alt={'photo'} className="photo avatar" onClick={() => { handleChangeImage() }} />
                    <br /><br /><br />
                    <div className="skipnextbox">
                        <button className="skipbutton" onClick={() => { nextPage() }}>Skip</button>
                    ...
                    <div className="policy2">
                        <span className="bold">Privacy Policy</span> and <span className="bold">Terms of Service</span> apply.
                    </div>
