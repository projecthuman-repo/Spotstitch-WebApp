      ...
      <div className="boss">
        ...
        <div className="right">
          ...
          <form className="formsignin" onSubmit={handleSubmit}>
            ...
            {!valid && (
              <p
                className="passwordRequirement alert alert-primary "
                role="alert"
              >
                Passwords must be between 8-10 characters long, have at least
            ...
            <br />
            {!matching && (
              <p className="passwordMatch alert alert-warning" role="alert">
